...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String locationQuery = sharedPreferences.getString(
                context.getString(R.string.pref_location_key),context.getString(R.string.pref_location_default)
        );
    ...
    public static boolean isMetric(Context context) {
        ...
        String isMetric = sharedPreferences.getString(context.getString(R.string.pref_units_key),
                context.getString(R.string.pref_units_metric));

        if (isMetric == context.getString(R.string.pref_units_metric)){
            return true;
        }else {
            return false;
        }
